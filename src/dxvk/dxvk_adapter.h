...
namespace dxvk {
  ...
  public:
    ...
    /**
     * \brief Checks for Intel Gen9/9.5 integrated GPU
     *
     * Targets SKL/KBL/CFL/WHL/AML/CML with deviceType INTEGRATED.
     * Used to enable low-power optimizations (dyasync, memory caps).
     * \returns \c true if adapter is Gen9/9.5 integrated.
     */
